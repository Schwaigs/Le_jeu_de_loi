...
function initBase() : void {
    ...
    $resultInsert = MyPDO::pdo()->prepare(
        ...
        (6,'Mélusine','catholique','Étranger',1,6,'femme','bon',2,'heritier',1,'tiers état'),
        (7,'Perceval','autre','France',2,3,'homme','faible',2,'heritier',0,'noblesse'),
        (8,'Clotaire','catholique','France',1,5,'homme','bon',5,'heritier',1,'tiers état'),
        (9,'Guenièvre','catholique','France',2,2,'femme','bon',5,'heritier',0,'clergé'),
        (12,'Yseult','catholique','France',4,10,'femme','moyen',1,'heritier',0,'clergé'),
        (17,'Cunégonde','catholique','Étranger',3,0,'femme','bon',5,'heritier',1,'noblesse'),
        (25,'Amaury','catholique','France',3,1,'homme','bon',2,'heritier',0,'tiers état')"
    );
