...
class Heritage {
    ...
    public function chercherHeritier(){
        ...
        $resultPerso = MyPDO::pdo()->prepare("SELECT id,parent,religion,sexe FROM perso WHERE classe not in ('mort','roi') and age>10");
        $resultPerso->execute();
    ...
    public function classePersoHeritier (array $heritiers) : void {
        ...
        $resultAffichage = MyPDO::pdo()->prepare("SELECT id from perso WHERE id in (".$in_heritiers.")");
    ...
    public function classePersoNonHeritier (array $heritiers) : void {
        ...
        $resultAffichage = MyPDO::pdo()->prepare("SELECT id from perso WHERE classe not in ('mort','roi') AND id not in (".$in_heritiers.")");
        $resultAffichage->execute();
