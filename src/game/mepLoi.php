<?php
    ...
    $_SESSION['message'] = "";
    // si la méthode HTTP utilisée n'est pas POST on demande une redirection vers le fichier jeu.php
    if ($_SERVER['REQUEST_METHOD']!='POST'){
        header('Location: ../home/jeu.php');
        exit();
    }
    // Si aucune loi n'as été choisit par le joueur on demande une redirection vers le fichier jeu.php pour qu'il en choissise une
    if (!isset($_POST['Lois']) || empty($_POST['Lois'])){
        header('Location: ../home/jeu.php');
        exit();
    }

    require_once '../model/classesPHP/Loi.php';
