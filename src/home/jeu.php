 ...
 */
  ...
  require_once '../model/initBase.php';
  ...
  require_once '../model/chercheCaracPerso.php';
  ...
  <body>
    ...
    <header>
      <div class="flex-container">
        ...
        <div id="titreJeu" style="flex-grow: 6"><a href="../game/quitter.php">Jeu de lois</a></div>
        ...
        <div id="encyclo" style="flex-grow: 2">
          <a href="../game/encyclopedie.php" onclick="window.open(this.href); return false;"><img id="imgEncyclo" src="../images/encyclopedie.png"></a>
        </div>
      </div>
    </header>
          ...
          <div class="evenements">
            ...
            <div class="contenuEvent">
              <!-- Remplissage par la page des event et de vote créé à part -->
                ...
                include '../game/choixEventLoi.php';
                ?>
            </div>
          </div>
        </div>
