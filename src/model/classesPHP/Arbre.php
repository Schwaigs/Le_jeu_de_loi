...
class Arbre {
    ...
    public function remplissageArbre(int $idParent, array $tableParentEnfants) : void {
        ...
        if (array_key_exists($idParent,$tableParentEnfants)){
            ...
            while (isset($tableParentEnfants[$idParent][$i])){
                ...
                echo'<a '.$class.' href="../home/jeu.php?refresh=0&id='.$tableParentEnfants[$idParent][$i].'"><img src="../../img/imgPersos/'.$sexe.$tableParentEnfants[$idParent][$i].'.png"></a>';
    ...
    */
    public function initArbre() : void {
        ...
        echo'<a '.$class.' href="../home/jeu.php?refresh=0&id=1"><img src="../../img/imgPersos/H1.png"></a>';
