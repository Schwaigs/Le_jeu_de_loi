...
<html lang="fr" dir="ltr">
  <head>
    ...
    <script >
      function avancerTuto() {
        document.body.style.backgroundImage = "url('../images/tuto".$_SESSION['numTuto'].".png')";
        <?php
        $_SESSION['numTuto']++;
         ?>
      }
  ...
  <div class="boutonAvancer">
    <form action="../pagesPHP/avanceTuto.php" method="post">
      <?php
          echo "<img src=../images/tuto".$_SESSION['numTuto'].".png>";
